import { defineComponent, computed, inject, unref, ref, hasInjectionContext, toRef, isRef, shallowRef, shallowReactive, getCurrentInstance, version, defineAsyncComponent, h, Suspense, nextTick, mergeProps, provide, watch, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, getCurrentScope, withCtx, useSSRContext, Text } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/ofetch/dist/node.mjs';
import { l as baseURL } from '../_/nitro.mjs';
import { createHooks } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestHeaders } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/defu/dist/defu.mjs';
import { parse as parse$1 } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/cookie-es/dist/index.mjs';
import destr from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/destr/dist/index.mjs';
import { hash, isEqual as isEqual$1 } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/ohash/dist/index.mjs';
import { klona } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/klona/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/vue-devtools-stub/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/Users/15270/Desktop/cv-reference/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "slug___en",
    path: "/en/:slug(.*)*",
    component: () => import('./document-driven-Cl0wu-iJ.mjs')
  },
  {
    name: "slug___zh",
    path: "/:slug(.*)*",
  ...
  },
  {
    name: "courses___en",
    path: "/en/courses",
    component: () => import('./courses-CHS4jyTZ.mjs')
  },
  {
    name: "courses___zh",
    path: "/courses",
  ...
  },
  {
    name: "index___en",
    path: "/en",
    component: () => import('./index-qtj2qnyE.mjs')
  },
  {
    name: "index___zh",
    path: "/",
  ...
  },
  {
    name: "journals___en",
    path: "/en/journals",
    component: () => import('./journals-BvZ2iiWJ.mjs')
  },
  {
    name: "journals___zh",
    path: "/journals",
  ...
  },
  {
    name: "labs___en",
    path: "/en/labs",
    component: () => import('./labs-DtJtGh4n.mjs')
  },
  {
    name: "labs___zh",
    path: "/labs",
  ...
  },
  {
    ...
    path: "/en/professors",
    component: () => import('./professors-CIzK50tD.mjs')
  },
  {
    name: "professors___zh",
    path: "/professors",
    component: () => import('./professors-CIzK50tD.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-CT4qpy7i.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-BT9sYrT2.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-BhCjQSHD.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-CwYhLP5R.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-C55_Rq47.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-CMB2ikF4.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-9bsmiLoE.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-Cwno3XVq.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BC6KG0so.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-CWPkX0Xg.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-CHk_pRLg.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DIFy6T0M.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-TRlqEiI0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-BV2xg9Pb.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-C8Tg-Mmw.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-DUKQh6Qs.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-CGpa2bva.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-CGjPdD8j.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-H3ypKKHg.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-ma9Lvwz0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-Dyw3KDsQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-DCTGW4sB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-D0R07iM6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-5pKOgTlL.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-bePqllsI.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-BiJyAJ9x.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-CC53M9ZF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-DSMj38nz.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-RIrqhxYv.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-DxZtnYT6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-BdljuFw1.mjs').then((r) => r["default"] || r.default || r));
...
const resource$1 = {
  "common": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Computer Vision Reference" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Global Computer Vision Labs, Professors, Courses and Conference Resources" } }
  },
  "nav": {
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Home" } },
    "labs": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Labs" } },
    "professors": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Professors" } },
    "courses": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Courses" } },
    "journals": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Journals" } }
  },
  "labs": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Computer Vision Labs Information" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Collection of top computer vision labs worldwide" } },
    "search": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Search labs" } },
    "searchPlaceholder": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Enter lab name or research area" } },
    "region": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Region filter" } },
    "allRegions": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "All regions" } },
    "northAmerica": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "North America" } },
    "europe": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Europe" } },
    "asia": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Asia" } },
    "china": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "China" } }
  }
};
const resource = {
  "common": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "计算机视觉资源参考" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "全球计算机视觉实验室、教授、课程和会议资源集合" } }
  },
  "nav": {
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "首页" } },
    "labs": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "实验室" } },
    "professors": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "教授" } },
    "courses": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "课程" } },
    "journals": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "期刊会议" } }
  },
  "labs": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "计算机视觉实验室信息" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "收集全球顶尖高校的计算机视觉实验室信息" } },
    "search": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "搜索实验室" } },
    "searchPlaceholder": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "输入实验室名称或研究方向" } },
    "region": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "地区筛选" } },
    "allRegions": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "全部地区" } },
    "northAmerica": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "北美" } },
    "europe": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "欧洲" } },
    "asia": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "亚洲" } },
    "china": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "中国" } }
  }
};
const localeCodes = [
  "en",
...
const localeLoaders = {
  ...
  "zh": [{ key: "../locales/zh.json", load: () => Promise.resolve(resource), cache: true }]
};
const vueI18nConfigs = [
  () => import(
    './i18n.config-DUsjt9gO.mjs'
...
const shouldUseClientDB = () => {
  const { experimental } = (/* @__PURE__ */ useRuntimeConfig()).public.content;
  {
    return false;
  }
};
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-vjBKAEFC.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-vjBKAEFC.mjs').then((m) => m.generateNavigation);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C0R4POZw.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DrAIO8nB.mjs'));
...
export { assertArray as A, apply as B, omit as C, sortList as D, withoutKeys as E, withKeys as F, createQuery as G, withBase as H, _export_sfc as _, useContent as a, useRequestEvent as b, __nuxt_component_0 as c, useRoute as d, entry$1 as default, withoutTrailingSlash as e, useState as f, fetchContentNavigation as g, hasProtocol as h, injectHead as i, joinURL as j, useNuxtApp as k, asyncDataDefaults as l, createError as m, useContentPreview as n, useRouter as o, parseQuery as p, queryContent as q, resolveUnrefHeadInput as r, resolveRouteObject as s, navigateTo as t, useRuntimeConfig as u, nuxtLinkDefaults as v, withTrailingSlash as w, withLeadingSlash as x, get as y, ensureArray as z };
